...
public class BankApiController {
    ...
    public OperationResult putMoney(@RequestParam(value = "id", required = true) int id, @RequestParam(value = "amount", required = true) double amount){
        Operations operations = new Operations(App.getSettings());
        return operations.putMoney(id, BigDecimal.valueOf(amount));
    }

    @RequestMapping("/takeMoney")
    public OperationResult takeMoney(@RequestParam(value = "id", required = true) int id, @RequestParam(value = "amount", required = true) double amount){
        Operations operations = new Operations(App.getSettings());
